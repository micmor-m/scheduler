...
export default function Application(props) {
  ...
  //this was before use useApplicationData ***********************************
  ...
  // 1 moved to useApplicationData ***********************************
  //const setDay = day => setState({ ...state, day });
  
// 2 moved to useApplicationData ***********************************
